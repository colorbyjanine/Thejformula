...
export default function BarPrepApp() {
  ...
  const [activeTab, setActiveTab] = useState<'study' | 'outlines' | 'practice'>('study');
  ...
  return (
    <div className="min-h-screen bg-[#0a0a0f] text-white">
      ...
      <main className="max-w-lg mx-auto px-5 pb-12">
        ...
        {activeTab === 'practice' && (
          <div className="space-y-6">
            <div className="bg-gradient-to-br from-purple-500/20 to-purple-600/5 border border-purple-500/30 rounded-2xl p-5">
              <p className="text-lg font-semibold text-purple-400 mb-2">✍️ Practice Essays</p>
              <p className="text-sm text-white/60">Model essays and sample answers for your midterms. Use IRAC format!</p>
            </div>
            ...
            <div className="bg-white/[0.03] border border-white/[0.06] rounded-2xl p-5">
              <div className="flex items-center gap-3 mb-4">
                ...
                <div>
                  <p className="font-semibold text-white/90">Civil Procedure</p>
                  <p className="text-xs text-white/40">Personal Jurisdiction • SMJ • Erie</p>
                </div>
              </div>
              
              {/* Essay 1: Personal Jurisdiction */}
              <div className="bg-white/[0.02] border border-white/[0.06] rounded-xl p-4 mb-3">
                <p className="text-sm font-medium text-emerald-400 mb-2">📝 Personal Jurisdiction - Model Answer</p>
                <div className="text-xs text-white/70 space-y-3 leading-relaxed">
                  <p><strong className="text-amber-400">ISSUE:</strong> Does the court have personal jurisdiction over D, an out-of-state defendant?</p>
                  
                  <p><strong className="text-amber-400">RULE:</strong> A court may exercise personal jurisdiction over a defendant who has "minimum contacts" with the forum state such that exercising jurisdiction would not offend "traditional notions of fair play and substantial justice." (International Shoe)</p>
                  
                  <p><strong className="text-amber-400">General vs. Specific Jurisdiction:</strong></p>
                  <p>• <strong>General PJ:</strong> D is "at home" in forum (domicile for individuals; state of incorporation or PPB for corporations)</p>
                  <p>• <strong>Specific PJ:</strong> Claim arises from D's contacts with forum. Requires: (1) Purposeful availment - D deliberately reached into forum; (2) Relatedness - claim arises from or relates to D's contacts; (3) Reasonableness - fair play factors favor jurisdiction</p>
                  
                  <p><strong className="text-amber-400">Stream of Commerce:</strong> Split in authority. Some courts require additional conduct (advertising, designing for market). Others find placing goods in stream sufficient if D knew products would reach forum.</p>
                  
                  <p><strong className="text-amber-400">Fairness Factors:</strong> (1) Burden on D; (2) Forum state's interest; (3) P's interest in relief; (4) Interstate judicial efficiency; (5) Shared policy interests</p>
                  
                  <p><strong className="text-amber-400">APPLICATION:</strong> Here, D [apply specific facts]. This [does/does not] constitute purposeful availment because [explain]. The claim [does/does not] arise from these contacts because [explain]. Exercising jurisdiction [would/would not] be reasonable considering [fairness factors].</p>
                  
                  <p><strong className="text-amber-400">CONCLUSION:</strong> The court [does/does not] have personal jurisdiction over D.</p>
                </div>
              </div>

              {/* Essay 2: SMJ Diversity */}
              <div className="bg-white/[0.02] border border-white/[0.06] rounded-xl p-4 mb-3">
                <p className="text-sm font-medium text-emerald-400 mb-2">📝 Subject Matter Jurisdiction - Diversity</p>
                <div className="text-xs text-white/70 space-y-3 leading-relaxed">
                  <p><strong className="text-amber-400">RULE:</strong> Federal courts have diversity jurisdiction when: (1) Complete diversity exists between all plaintiffs and all defendants; AND (2) Amount in controversy exceeds $75,000.</p>
                  
                  <p><strong className="text-amber-400">Citizenship:</strong></p>
                  <p>• Individuals: State of domicile (physical presence + intent to remain)</p>
                  <p>• Corporations: State of incorporation AND principal place of business ("nerve center" - where officers direct/control activities)</p>
                  <p>• LLCs/Partnerships: Citizenship of ALL members</p>
                  
                  <p><strong className="text-amber-400">Amount in Controversy:</strong></p>
                  <p>• Legal certainty test: Claim dismissed only if "legally certain" P cannot recover $75K+</p>
                  <p>• Aggregation: Single P can aggregate all claims against single D</p>
                  <p>• Multiple Ps: Cannot aggregate unless claims arise from same title/right</p>
                  
                  <p><strong className="text-amber-400">Time of Filing:</strong> Diversity determined when complaint filed. Later changes in citizenship don't destroy jurisdiction.</p>
                </div>
              </div>

              {/* Essay 3: Erie */}
              <div className="bg-white/[0.02] border border-white/[0.06] rounded-xl p-4">
                <p className="text-sm font-medium text-emerald-400 mb-2">📝 Erie Doctrine - Choice of Law</p>
                <div className="text-xs text-white/70 space-y-3 leading-relaxed">
                  <p><strong className="text-amber-400">RULE:</strong> In diversity cases, federal courts apply state substantive law and federal procedural law. (Erie Railroad v. Tompkins)</p>
                  
                  <p><strong className="text-amber-400">Analysis Framework:</strong></p>
                  <p>1. Is there a Federal Rule of Civil Procedure on point?</p>
                  <p>   → If valid FRCP applies, use federal rule (Hanna v. Plumer)</p>
                  <p>2. If no FRCP, is the state rule "substantive" or "procedural"?</p>
                  <p>   → Apply "Twin Aims" test: Would applying federal rule (a) encourage forum shopping? (b) lead to inequitable administration of law?</p>
                  <p>   → If yes to either, apply STATE rule</p>
                  
                  <p><strong className="text-amber-400">Outcome-Determinative Test:</strong> If applying different rules would change the outcome, lean toward state law (Guaranty Trust).</p>
                  
                  <p><strong className="text-amber-400">Common Erie Issues:</strong></p>
                  <p>• Statute of limitations → Substantive (state law)</p>
                  <p>• Burden of proof → Substantive (state law)</p>
                  <p>• Attorney-client privilege → Federal common law</p>
                  <p>• Service of process → FRCP 4 controls</p>
                </div>
              </div>
            </div>
            ...
            <div className="bg-white/[0.03] border border-white/[0.06] rounded-2xl p-5">
              <div className="flex items-center gap-3 mb-4">
                ...
                <div>
                  <p className="font-semibold text-white/90">Criminal Law</p>
                  <p className="text-xs text-white/40">Homicide • Defenses • Inchoate Crimes</p>
                </div>
              </div>
              
              {/* Essay 1: Homicide */}
              <div className="bg-white/[0.02] border border-white/[0.06] rounded-xl p-4 mb-3">
                <p className="text-sm font-medium text-rose-400 mb-2">📝 Homicide Analysis Framework</p>
                <div className="text-xs text-white/70 space-y-3 leading-relaxed">
                  <p><strong className="text-amber-400">Step 1: Was there a homicide?</strong> Killing of a human being by another human being.</p>
                  
                  <p><strong className="text-amber-400">Step 2: Murder or Manslaughter?</strong></p>
                  <p><strong>MURDER</strong> = Killing with "malice aforethought":</p>
                  <p>• Intent to kill</p>
                  <p>• Intent to cause serious bodily harm</p>
                  <p>• Depraved heart (extreme recklessness)</p>
                  <p>• Felony murder (during enumerated felony)</p>
                  
                  <p><strong>VOLUNTARY MANSLAUGHTER</strong> = Adequate provocation</p>
                  <p>• Actual heat of passion</p>
                  <p>• Legally adequate provocation (objective)</p>
                  <p>• No cooling off period</p>
                  <p>• Causal connection between provocation and killing</p>
                  
                  <p><strong>INVOLUNTARY MANSLAUGHTER</strong> = Criminal negligence or misdemeanor manslaughter</p>
                  
                  <p><strong className="text-amber-400">Step 3: First or Second Degree?</strong></p>
                  <p>• 1st Degree: Premeditated and deliberate OR felony murder (BARRK: Burglary, Arson, Robbery, Rape, Kidnapping)</p>
                  <p>• 2nd Degree: All other murder</p>
                  
                  <p><strong className="text-amber-400">Sample Application:</strong> D shot V after V insulted D's mother. Here, D acted with intent to kill (pointed gun, pulled trigger). The issue is whether adequate provocation reduces to voluntary manslaughter. Words alone are generally insufficient provocation. However, if accompanied by conduct... [continue analysis]</p>
                </div>
              </div>

              {/* Essay 2: Self-Defense */}
              <div className="bg-white/[0.02] border border-white/[0.06] rounded-xl p-4 mb-3">
                <p className="text-sm font-medium text-rose-400 mb-2">📝 Self-Defense</p>
                <div className="text-xs text-white/70 space-y-3 leading-relaxed">
                  <p><strong className="text-amber-400">RULE:</strong> A person may use reasonable force to defend themselves when they reasonably believe force is necessary to prevent imminent unlawful harm.</p>
                  
                  <p><strong className="text-amber-400">Elements:</strong></p>
                  <p>1. Reasonable belief of imminent threat</p>
                  <p>2. Proportional force (deadly force only against deadly threat)</p>
                  <p>3. Not the initial aggressor (unless withdrew)</p>
                  <p>4. Duty to retreat? (Majority: No duty; Minority: Must retreat if safe)</p>
                  
                  <p><strong className="text-amber-400">Deadly Force:</strong> Only justified when D reasonably believes deadly force is necessary to prevent death or serious bodily harm.</p>
                  
                  <p><strong className="text-amber-400">Imperfect Self-Defense:</strong> If D had honest but unreasonable belief → reduces murder to voluntary manslaughter (some jurisdictions).</p>
                </div>
              </div>

              {/* Essay 3: Accomplice Liability */}
              <div className="bg-white/[0.02] border border-white/[0.06] rounded-xl p-4">
                <p className="text-sm font-medium text-rose-400 mb-2">📝 Accomplice Liability</p>
                <div className="text-xs text-white/70 space-y-3 leading-relaxed">
                  <p><strong className="text-amber-400">RULE:</strong> An accomplice is liable for the crime they aided/encouraged AND all foreseeable crimes committed in furtherance.</p>
                  
                  <p><strong className="text-amber-400">Elements:</strong></p>
                  <p>1. Actus Reus: Aid, encourage, or assist (words or conduct)</p>
                  <p>2. Mens Rea: Intent to assist AND intent that crime be committed</p>
                  
                  <p><strong className="text-amber-400">Scope:</strong> Accomplice liable for:</p>
                  <p>• The target crime</p>
                  <p>• All natural and probable consequences of target crime</p>
                  
                  <p><strong className="text-amber-400">Withdrawal:</strong> Must (1) notify principal; (2) attempt to neutralize assistance</p>
                </div>
              </div>
            </div>
            ...
            <div className="bg-white/[0.03] border border-white/[0.06] rounded-2xl p-5">
              <div className="flex items-center gap-3 mb-4">
                <span className="text-2xl">📜</span>
                <div>
                  <p className="font-semibold text-white/90">Professional Responsibility</p>
                  <p className="text-xs text-white/40">Conflicts • Confidentiality • Competence</p>
                </div>
              </div>
              
              {/* Essay 1: Conflicts */}
              <div className="bg-white/[0.02] border border-white/[0.06] rounded-xl p-4 mb-3">
                <p className="text-sm font-medium text-blue-400 mb-2">📝 Conflicts of Interest (Rule 1.7)</p>
                <div className="text-xs text-white/70 space-y-3 leading-relaxed">
                  <p><strong className="text-amber-400">Current Client Conflicts (Rule 1.7):</strong></p>
                  <p>Direct adversity OR material limitation risk</p>
                  
                  <p><strong className="text-amber-400">Waivable if ALL met:</strong></p>
                  <p>1. Lawyer reasonably believes can provide competent representation</p>
                  <p>2. Not prohibited by law</p>
                  <p>3. Not same litigation, opposite sides</p>
                  <p>4. Each client gives INFORMED CONSENT, confirmed in writing</p>
                  
                  <p><strong className="text-amber-400">Former Client Conflicts (Rule 1.9):</strong></p>
                  <p>Same or substantially related matter + materially adverse → need consent</p>
                  
                  <p><strong className="text-amber-400">"Hot Potato" Rule:</strong> Cannot drop current client to take on more lucrative adverse client</p>
                  
                  <p><strong className="text-amber-400">Imputation (Rule 1.10):</strong> One lawyer's conflict imputed to entire firm UNLESS:</p>
                  <p>• Personal interest conflict only</p>
                  <p>• Properly screened + notice + no fee sharing</p>
                </div>
              </div>

              {/* Essay 2: Confidentiality */}
              <div className="bg-white/[0.02] border border-white/[0.06] rounded-xl p-4 mb-3">
                <p className="text-sm font-medium text-blue-400 mb-2">📝 Confidentiality (Rule 1.6)</p>
                <div className="text-xs text-white/70 space-y-3 leading-relaxed">
                  <p><strong className="text-amber-400">RULE:</strong> Lawyer shall NOT reveal information relating to representation without client consent.</p>
                  
                  <p><strong className="text-amber-400">Scope:</strong> Broader than attorney-client privilege - covers ALL information related to representation, regardless of source.</p>
                  
                  <p><strong className="text-amber-400">Exceptions (MAY disclose):</strong></p>
                  <p>• Prevent reasonably certain death or substantial bodily harm</p>
                  <p>• Prevent client crime/fraud causing substantial financial harm (if lawyer's services used)</p>
                  <p>• Secure legal advice about ethics compliance</p>
                  <p>• Establish claim/defense in dispute with client</p>
                  <p>• Comply with court order or law</p>
                  
                  <p><strong className="text-amber-400">Duty continues after representation ends.</strong></p>
                </div>
              </div>

              {/* Essay 3: Competence */}
              <div className="bg-white/[0.02] border border-white/[0.06] rounded-xl p-4">
                <p className="text-sm font-medium text-blue-400 mb-2">📝 Competence & Diligence (Rules 1.1, 1.3)</p>
                <div className="text-xs text-white/70 space-y-3 leading-relaxed">
                  <p><strong className="text-amber-400">Competence (1.1):</strong> Legal knowledge, skill, thoroughness, preparation reasonably necessary</p>
                  
                  <p><strong className="text-amber-400">Factors:</strong></p>
                  <p>• Complexity of matter</p>
                  <p>• Lawyer's experience</p>
                  <p>• Preparation possible</p>
                  <p>• Association with competent lawyer possible</p>
                  
                  <p><strong className="text-amber-400">Diligence (1.3):</strong> Reasonable diligence and promptness</p>
                  <p>• No procrastination</p>
                  <p>• Carry through to completion</p>
                  <p>• Workload must permit adequate attention</p>
                  
                  <p><strong className="text-amber-400">Communication (1.4):</strong> Keep client reasonably informed; respond to reasonable requests; explain enough for informed decisions</p>
                </div>
              </div>
            </div>
            ...
            <div className="bg-white/[0.02] border border-white/[0.06] rounded-2xl p-5">
              <p className="text-sm font-medium text-white/80 mb-3">📚 More Practice Resources</p>
              <div className="space-y-2 text-xs">
                <a href="https://www.quimbee.com/essay-practice-exams" target="_blank" rel="noopener noreferrer" className="block p-3 bg-white/[0.03] rounded-lg hover:bg-white/[0.06] transition text-white/70 hover:text-white">
                  Quimbee → 32 essays per subject with model answers
                </a>
                <a href="https://www.calbar.ca.gov/Admissions/Examinations/California-Bar-Examination/Past-Exams" target="_blank" rel="noopener noreferrer" className="block p-3 bg-white/[0.03] rounded-lg hover:bg-white/[0.06] transition text-white/70 hover:text-white">
                  CA Bar → Past exams with selected answers
                </a>
                <a href="https://www.ncbex.org/exams/mpre" target="_blank" rel="noopener noreferrer" className="block p-3 bg-white/[0.03] rounded-lg hover:bg-white/[0.06] transition text-white/70 hover:text-white">
                  NCBE → Official MPRE sample questions
                </a>
              </div>
            </div>
          </div>
