...
const collections = {
  ...
  wellness: {
    ...
    products: [
      ...
      { name: "+ Lux Unfiltered N°12 Face Tanning Drops", amazonId: "B0F5B746TS", price: "$46", tag: "Self Tan" },
      { name: "Anastasia Beverly Hills Microstroke Brow Pen", amazonId: "B0FFBSJ5S3", price: "$23", tag: "Brows" },
      { name: "MERIT Minimalist Complexion Stick", amazonId: "B0C7WLJ5MP", price: "$59", tag: "Clean Beauty" },
      { name: "Bobbi Brown Long-Wear Cream Shadow Stick", amazonId: "B00B8SSMP8", price: "$35", tag: "Eyes" },
      { name: "tarte Maracuja Juicy Lip Liner", amazonId: "B0CCPGYCSC", price: "$23", tag: "Lips" },
      { name: "Vacation Sunscreen Spray SPF 30 (3-Pack)", amazonId: "B0BSV4285T", price: "$54", tag: "Sun Care" },
    ],
  },
  tools: {
    title: "Tools & Styling",
  ...
  home: {
    ...
    products: [
      ...
      { name: "Loloi Chris Loves Julia Scottie Rug", amazonId: "B0DHWD42YJ", price: "$89", tag: "Rug" },
      { name: "AmorArc Ceramic Dinnerware Set 18pc", amazonId: "B0CJD73LV6", price: "$75", tag: "Dining" },
      { name: "MaisoNovo Shower Dispenser Set of 3", amazonId: "B0B816Y7VX", price: "$30", tag: "Bathroom" },
      { name: "Farberware Stainless Steel Roasting Pan", amazonId: "B09Y69295C", price: "$40", tag: "Kitchen" },
      { name: "KitchenAid Artisan 5Qt Stand Mixer", amazonId: "B00007G309", price: "$450", tag: "Investment" },
      { name: "Rolling Egg Holder for Fridge", amazonId: "B0CLV5X2LH", price: "$18", tag: "Organization" },
      { name: "All-Clad D5 Stainless Cookware Set 10pc", amazonId: "B006ZNCMBQ", price: "$900", tag: "Investment" },
      { name: "Nuwave Brio Plus Air Fryer 8Qt (Cream)", amazonId: "B0DFKFTJSV", price: "$130", tag: "Kitchen" },
    ],
  },
  kids: {
    title: "Kids & Family",
