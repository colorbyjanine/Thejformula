...
const collections = {
  ...
  fashion: {
    ...
    products: [
      ...
      { name: "ViewJoy Retro Oval Sunglasses 2-Pack", amazonId: "B0F8HWPP54", price: "$17", tag: "Y2K", image: "/products/retro-sunglasses.jpg" },
      { name: "Ray-Ban Oval Sunglasses Black", amazonId: "B0DP3D8Q5P", price: "$128", tag: "Classic" },
      { name: "DLOODA Pleated Tennis Skirt with Pockets", amazonId: "B0DSSDPFY5", price: "$25", tag: "Athletic", image: "/products/pleated-tennis-skirt.jpg" },
      { name: "ABOCIW Athletic Tennis Dress", amazonId: "B0DDXWTR5K", price: "$40", tag: "Athletic", image: "/products/tennis-dress-navy.jpg" },
      { name: "Trendy Queen 2-Piece Lounge Set", amazonId: "B0DXBYDK56", price: "$35", tag: "Travel" },
      { name: "Ceoon Pilates Grip Socks 3-Pack", amazonId: "B0CZ384SXK", price: "$12", tag: "Pilates", image: "/products/pilates-socks.jpg" },
      { name: "ANRABESS Rib Knit Slim Fit Top", amazonId: "B0DDGXNQTY", price: "$25", tag: "Basic", image: "/products/black-ribbed-top.jpg" },
      { name: "MICIFA Mesh Ballet Flats", amazonId: "B0D46DGX6M", price: "$50", tag: "Chic", image: "/products/mesh-ballet-flats.jpg" },
      { name: "Lhamo Latso Satin Bow Flats", amazonId: "B0FR3PX9C7", price: "$46", tag: "Elegant", image: "/products/gingham-ballet-flats.jpg" },
      { name: "GTBINGGO Square Toe Mary Jane Flats", amazonId: "B0FNDQD8NR", price: "$40", tag: "Classic", image: "/products/suede-camel-flats.jpg" },
      { name: "THESHY Square Toe Slide Sandals", amazonId: "B0DBTN139J", price: "$35", tag: "Summer", image: "/products/brown-suede-sandals.jpg" },
      { name: "Veja Volley Canvas Sneakers", amazonId: "B0DVVC8BSQ", price: "$115", tag: "Sustainable", image: "/products/veja-volley-pink.jpg" },
      { name: "Veja Campo Bold Sneakers", amazonId: "B082X7X2RD", price: "$175", tag: "Sustainable", image: "/products/veja-campo-pink.jpg" },
      ...
      { name: "SweatyRocks Asymmetrical Mock Neck Top", amazonId: "B0FK4NZM2T", price: "$26", tag: "Going Out", image: "/products/asymmetric-black-top.jpg" },
      ...
      { name: "Acelitt Linen Beach Pants", amazonId: "B0CGVBQ95D", price: "$30", tag: "Vacation", image: "/products/white-lace-pants.jpg" },
      { name: "PRETTYGARDEN Strapless Maxi Dress", amazonId: "B0DKDXYVY2", price: "$45", tag: "Vacation", image: "/products/maxi-dress-colorblock.jpg" },
      { name: "Y2K Polka Dot Halter Maxi Dress", amazonId: "B0DYNZ7611", price: "$38", tag: "Vacation", image: "/products/polka-dot-maxi.jpg" },
      { name: "Xunger Cropped Bomber Jacket", amazonId: "B0FNBRCSQH", price: "$33", tag: "Streetwear", image: "/products/tan-bomber-jacket.jpg" },
      ...
      { name: "Project Cloud Leather Clogs", amazonId: "B0DHSXW6VT", price: "$90", tag: "Comfort", image: "/products/suede-clogs.jpg" },
      { name: "Panadila Sherpa Fleece Pullover", amazonId: "B0FKT96JLJ", price: "$46", tag: "Cozy", image: "/products/blue-sherpa-pullover.jpg" },
      { name: "ABYOVRT Backless Bodycon Maxi Dress", amazonId: "B0C5CKRWGR", price: "$40", tag: "Going Out", image: "/products/backless-black-dress.jpg" },
    ],
  },
  home: {
    title: "Home & Kitchen",
