...
const collections = {
  hair: {
    ...
    products: [
      ...
      { name: "Amika Un.Done Texture Spray", amazonId: "B00MF80PEQ", price: "$29", tag: "Texture" },
  ...
  wellness: {
    ...
    products: [
      { name: "Nutrafol Women Hair Growth", amazonId: "B01NGTV7PQ", price: "$88", tag: "Hair Growth" },
  ...
  tools: {
    ...
    products: [
      { name: "Dyson Airwrap Complete", amazonId: "B0BWHW9KSK", price: "$599", tag: "Investment" },
      ...
      { name: "Olivia Garden Round Brush", amazonId: "B001T0FNIA", price: "$25", tag: "Blowout" },
  ...
  home: {
    ...
    products: [
      { name: "Vtopmart Clear Containers Set", amazonId: "B07YQSQJKG", price: "$35", tag: "Pantry Goals" },
      { name: "StorageWorks Woven Baskets", amazonId: "B07T2R5YDH", price: "$30", tag: "Storage" },
  ...
  style: {
    ...
    products: [
      { name: "PAVOI 14K Gold Huggie Hoops", amazonId: "B07BDFV1M5", price: "$14", tag: "Everyday" },
